document.addEventListener("DOMContentLoaded", function () {
	...
	const lines = [
		...
		"],",
		"projects : [",
		'"Predicting days until a DoB Complaint is inspected!https://github.com/Shaddyjr/dob_complaints",',
		'"Bee Image Classifier Website!https://bee-image-classifier.herokuapp.com/",',
		'"Bee Image Classifier Repo!https://github.com/Shaddyjr/bee-image-classifier",',
		...
		"],",
		"social : {",
		'linkedin : "mahdi-shadkam-farrokhi!https://www.linkedin.com/in/mahdi-shadkam-farrokhi",',
		'github : "Shaddyjr!https://github.com/Shaddyjr",',
		'youtube : "Glitched Failure!https://www.youtube.com/channel/UCErSNiDZV4rJCNB8NrDGREA",',
		"},",
		'contact : "mahdis.pw@gmail.com!mailto:mahdis.pw@gmail.com"',
		"}",
	]

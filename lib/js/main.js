document.addEventListener("DOMContentLoaded", function () {
    ...
    const lines = [
        ...
        '"Silly React Quiz!https://mahdiasc.github.io/silly_react_quiz/",',
        '"ASC Readathon Application!https://2019-readathon.glitch.me/"',
        '],',
        'social : {',
        'linkedin : "mahdi-shadkamfarrokhi!https://www.linkedin.com/in/mahdi-shadkam-farrokhi-8a410958/",',
    ...
    async function setupPage() {
        ...
        await delayedTask(null, 3000);
        initial.classList.remove(CURSOR_CLASSNAME);
        ...
        for (const div of lineDivs) {
            ...
            for (const p of ps) {
                await typeText(p, null, SPEED_TYPE_DELAY);
